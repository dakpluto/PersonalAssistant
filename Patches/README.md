...
| `Machinehead-Bush` | Machinehead — Bush (147 BPM, est.) | P/J | No (GP-5 only) | NAM: Ampeg V4B, Slot 68 | CTL on PRE Micro Boost + RVB Room: dry driving verse groove vs. boosted, roomier chorus |
| `Adrift-LS` | Adrift — Lunatic Soul | Sire fretless (Active) | No (GP-5 only) | NAM: Darkglass Harmonic Booster (clean), Slot 60 | Atmospheric/ambient prog build; CTL on DLY (Analog) + RVB Hall: dry/close verse vs. big spacious swell |
| `Anthem-GC` | The Anthem — Good Charlotte | P/J | No (GP-5 only) | NAM: Ampeg V4B, Slot 68 | CTL on DST (Bass OD) + RVB Room: tight dry verse punch vs. grittier, bigger chorus |
| `StreamCons-DT` | Stream of Consciousness — Dream Theater (instrumental) | P/J | No (GP-5 only) | NAM: Darkglass B7K Ultra, Slot 64 | CTL on PRE Micro Boost + DST Bass OD + RVB Room: moody intro/unison passages vs. full-band blast sections |
| `Metropolis1-DT` | Metropolis Pt. 1, The Miracle and the Sleeper — Dream Theater (~130 BPM, est.) | P/J | No (GP-5 only) | NAM: Darkglass Alpha Omega (Distortion), Slot 62 | CTL on PRE Micro Boost + RVB Room (inverted): quiet intro/interlude vs. driving main riff |
| `PullMeUnder-DT` | Pull Me Under — Dream Theater | P/J | No (GP-5 only) | NAM: Mesa M-Pulse Big Block 750 (Clean Channel), Slot 70 | CTL on DST Bass OD + RVB Room: dry driving verse/chorus groove vs. grittier instrumental-break push |
| `SpiritCarriesOn-DT` | The Spirit Carries On — Dream Theater | Sire fretless (Active) | No (GP-5 only) | NAM: Darkglass Harmonic Booster (clean), Slot 60 | CTL on PRE Micro Boost + RVB Hall: restrained verse vs. boosted gospel-choir climax |
...
| `Lady-KR` | Lady — Kenny Rogers (~68 BPM) | Sire fretless (Active) | No (GP-5 only) | NAM: Darkglass Harmonic Booster (clean), Slot 60 | Silky Lionel Richie-penned soul ballad; CTL on RVB Hall only: dry close verse vs. subtle bridge/final-chorus swell |
| `Comedown-Bush` | Comedown — Bush (~92 BPM, est.) | P/J | No (GP-5 only) | NAM: Darkglass Alpha Omega (Fuzz), Slot 63 | Darker/moodier sibling to Machinehead; CTL on PRE Micro Boost + RVB Room: murky restrained verse vs. heavier fuzzed chorus |
