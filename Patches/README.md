...
| `WaitingOnTheWorld-JohnMayer` | Waiting on the World to Change — John Mayer (~88 BPM, est.) | P/J | No (GP-5 only) | AMP: Classic Bass + IR: Apg115, Slot 1 | Pino-style muted soul thump (flatwound impression); CTL on RVB Room: verse vs. chorus |
