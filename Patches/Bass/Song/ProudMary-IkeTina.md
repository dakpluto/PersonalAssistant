...
- Gain: 35, Bass: 58, Middle: 58, MidFreq: 800Hz, Treble: 54, VOL: 66
- Always on, same for both CTL states.
- MidFreq at 800Hz (rather than the warmer 450Hz used on a pure ballad build) gives this real attack and definition — this same setting has to serve both the sultry slow intro and the fast, syncopated funk groove, and the funk section especially needs that bite to cut through horns and driving drums.

**CAB — User IR 1 (Apg115)**
- VOL: 60
- Always on, same for both CTL states.
- Ampeg Heritage B-15 — the quintessential Motown/soul-era bass voicing, and genuinely the era-correct amp for this exact record. Works for both halves of the song: warm and sultry for the intro, girthy and present for the fast groove.
...
- Ampeg Heritage B-15, confirmed loaded on User IR slot 1. The classic Motown/soul-era bass amp voicing — a direct, era-correct match for this record.
