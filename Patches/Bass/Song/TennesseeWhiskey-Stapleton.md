...
- Gain: 30, Bass: 62, Middle: 52, MidFreq: 450Hz, Treble: 45, VOL: 65
- Always on, same for both CTL states.
- Gain kept low — just enough natural amp character, no real push. MidFreq at 450Hz (rather than the growlier 800Hz used on more aggressive builds) sits in a warmer, rounder pocket that matches the mellow ballad instead of adding bark.

**CAB — User IR 1 (Apg115)**
- VOL: 60
- Always on, same for both CTL states.
- Ampeg Heritage B-15 capture — the classic soul/Motown-era bass amp, girthy low end with a prominent 100Hz peak. Perfectly suited to this song's soul-blues roots, and the suggested real-world pairing for the Classic Bass AMP model above.
...
- Ampeg Heritage B-15, confirmed loaded on User IR slot 1. Prominent 100Hz peak adds real girth — the classic warm soul/blues bass voicing.
